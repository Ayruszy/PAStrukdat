...
string obatUntukKeluhan(const string& keluhan_pasien) {
    if (keluhan_pasien == "Gigi") {
        ...
        return "Obat Cataflam";
    } else if (keluhan_pasien == "flu") {
        return "Obat Antitusif";
    } else if (keluhan_pasien == "radang") {
        return "Obat Antitusif";
    } else if (keluhan_pasien == "alergi") {
        return "Obat Antihistamin";
    } else if (keluhan_pasien == "sendi") {
        return "Obat Analgesik";
    } else if (keluhan_pasien == "depresi") {
        return "Obat Antidepresan";
    } else if (keluhan_pasien == "jantung") {
        return "Obat Antihipertensi";
    } else if (keluhan_pasien == "diabetes") {
        return "Obat Insulin";
    } else if (keluhan_pasien == "asma") {
        return "Obat inhaler";
    } else if (keluhan_pasien == "bakteri") {
        return "Obat Antibiotik";
    } else if (keluhan_pasien == "virus") {
        return "Obat Antivirus";
    } else {
        return "Obat Tidak Ditemukan... Banyak Banyak Istirahat Ya";
    }
}
